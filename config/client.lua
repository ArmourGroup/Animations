return {
    Anim = {
        ...
        ['dancar379'] = {
            dict = 'anim@amb@nightclub@mini@dance@dance_paired@dance_f@',
        ...
        ['dancar381'] = {
            dict = 'anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@',
            anim =
        ...
        ['dancar382'] = {
            dict = 'anim@amb@nightclub@mini@dance@dance_paired@dance_h@',
            anim = 'ped_b_dance_idle',
            walk = false,
            loop = true
        },
        ['dancar383'] = {
            dict = 'anim@amb@nightclub@mini@dance@dance_paired@dance_j@',
            anim = 'ped_a_dance_idle',
            walk = false,
            loop = true
        },
        ['dancar384'] = {
            dict = 'anim@amb@nightclub@mini@dance@dance_paired@dance_m@',
            anim = 'ped_a_dance_idle',
            walk = false,
            loop = true
        },
        ...
        ['dancar387'] = {
            dict = 'anim@mp_player_intcelebrationfemale@crowd_invitation',
            anim = 'crowd_invitation',
            walk = false,
            loop = true
        },
        ['dancar388'] = {
            dict = 'anim@mp_player_intcelebrationfemale@driver',
            anim = 'driver',
            walk = false,
            loop = true
        },
        ['dancar389'] = {
            dict = 'anim@mp_player_intcelebrationfemale@shooting',
            anim = 'shooting',
            walk = false,
            loop = true
        },
        ['dancar390'] = {
            dict = 'anim@mp_player_intcelebrationmale@shooting',
            anim = 'shooting',
            walk = false,
            loop = true
        },
        ['dancar391'] = {
            dict = 'anim@mp_player_intcelebrationmale@suck_it',
            anim = 'suck_it',
            walk = false,
            loop = true
        },
        ['dancar392'] = {
            dict = 'anim@mp_player_intuppercrowd_invitation',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ['dancar393'] = {
            dict = 'anim@mp_player_intuppershooting',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ['dancar394'] = {
            dict = 'anim@mp_player_intuppersuck_it',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ...
        ['sitchair6'] = {
            dict = 'timetable@reunited@ig_10',
            anim = 'isthisthebest_jimmy',
            walk = false,
            loop = true
        },
        ['sitchair7'] = {
            dict = 'timetable@michael@on_sofabase',
            anim = 'sit_sofa_base',
            walk = false,
            loop = true
        },
        ...
        ['sentar25'] = {
            dict = 'anim@amb@office@boss@female@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar26'] = {
            dict = 'anim@amb@casino@out_of_money@ped_female@01a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar27'] = {
            dict = 'anim@amb@casino@out_of_money@ped_female@01b@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar28'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@engaged@01a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar29'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_male@regular@01b@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar30'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_male@regular@02a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar32'] = {
            dict = 'anim_casino_a@amb@casino@games@slots@ped_female@regular@02a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar33'] = {
            dict = 'anim_casino_b@amb@casino@games@blackjack@ped_male@engaged@01a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar34'] = {
            ...
            anim = 'air_guitar_01_a',
            walk = false,
            loop = true
        },
        ['sentar35'] = {
            dict = 'missheistdocks2aleadinoutlsdh_2a_int',
            anim = 'sitting_loop_wade',
            walk = false,
            loop = true
        },
        ['sentar36'] = {
            dict = 'switch@franklin@stripclub2',
            anim = 'ig_16_base',
            walk = false,
            loop = true
        },
        ['sentar37'] = {
            dict = 'switch@michael@restaurant',
            anim = '001510_02_gc_mics3_ig_1_base_amanda',
            walk = false,
            loop = true
        },
        ['sentar38'] = {
            dict = 'switch@michael@ronex_ig_5_p2',
            anim = 'base_michael',
            walk = false,
            loop = true
        },
        ...
        ['sentar40'] = {
            dict = 'timetable@reunited@ig_7',
            anim = 'amandabase_amanda',
            walk = false,
            loop = true
        },
        ['sentar41'] = {
            dict = 'drf_mic_1_cs_1-15',
            anim = 'cs_drfriedlander_dual-15',
            walk = false,
            loop = true
        },
        ['sentar42'] = {
            dict = 'mini@strip_club@backroom@',
            anim = 'leadin_loop_idle_c_stripper_c',
            walk = false,
            loop = true
        },
        ['sentar43'] = {
        ...
        ['sentar44'] = {
            dict = 'switch@michael@sitting_on_car_premiere',
            anim = 'sitting_on_car_premiere_loop_player',
            walk = false,
            loop = true
        },
        ['sentar45'] = {
        ...
        ['sentar46'] = {
            dict = 'switch@michael@opens_door_for_ama',
            anim = '001895_02_mics3_17_opens_door_for_ama_idle_ama',
            walk = false,
            loop = true
        },
        ['sentar47'] = {
            dict = 'switch@michael@lounge_chairs',
            anim = '001523_01_mics3_9_lounge_chairs_idle_mic',
            walk = false,
            loop = true
        },
        ['sentar48'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@engaged@01a@base_big_screen',
            anim =
            'base_big_screen',
            walk = false,
            loop = true
        ...
        ['sentar49'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@engaged@01b@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar50'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@engaged@01b@base_big_screen',
            anim =
            'base_big_screen',
            walk = false,
            loop = true
        ...
        ['sentar51'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@regular@01a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar52'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_female@regular@01b@base_big_screen',
            anim =
            'base_big_screen',
            walk = false,
            loop = true
        ...
        ['sentar53'] = {
            dict = 'anim_casino_a@amb@casino@games@insidetrack@ped_male@regular@02a@trans',
            anim =
            'base_to_big_screen',
            walk = false,
            loop = true
        ...
        ['sentar55'] = {
            ...
            anim = 'jh_int_outro_loop_d',
            walk = false,
            loop = true
        },
        ['sentar56'] = {
            dict = 'anim@amb@business@cfm@cfm_machine_no_work@',
            anim = 'smokers_cough_v1_operator',
            walk = false,
            loop = true
        },
        ['sentar57'] = {
        ...
        ['sentar59'] = {
            ...
            anim = 'world_human_picnic_female_lo_res_base',
            walk = false,
            loop = true
        },
        ['sentar60'] = {
            dict = 'missheistdocks2aleadinoutlsdh_2a_int',
            anim = 'massage_loop_2_trevor',
            walk = false,
            loop = true
        },
        ['sentar61'] = {
            dict = 'anim_casino_b@amb@casino@games@blackjack@ped_female@no_heels@regular@02a@reacts@v01',
            anim =
            'reaction_impartial_var03',
            walk = false,
            loop = true
        },
        ['sentar62'] = {
        ...
        ['sentar64'] = {
            dict = 'sil_int-29',
            anim = 'mp_m_freemode_01^3_dual-29',
            walk = false,
            loop = true
        },
        ['sentar65'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_a@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar66'] = {
            dict = 'safe@michael@ig_3',
            anim = 'base_michael',
            walk = false,
            loop = true
        },
        ...
        ['sentar72'] = {
            dict = 'anim@amb@office@seating@female@var_b@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar74'] = {
            dict = 'anim@amb@facility@briefing_room@seating@male@var_a@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar75'] = {
            ...
            anim =
            'lookaround_phoneless_lazyworker',
            walk = false,
            loop = true
        },
        ['sentar76'] = {
            dict = 'arm_1_mcs_2_concat-0',
            anim = 'cs_denise_dual-0',
            walk = false,
            loop = true
        },
        ['sentar77'] = {
        ...
        ['sentar78'] = {
            dict = 'anim@amb@yacht@jacuzzi@seated@female@variation_05@',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ['sentar79'] = {
            dict = 'family_4_mcs_2-2',
            anim = 'csb_hugh_dual-2',
            walk = false,
            loop = true
        },
        ['sentar80'] = {
            dict = 'anim@amb@office@boardroom@crew@female@var_a@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar84'] = {
            dict = 'hs3_pln_int-0',
            anim = 'csb_huang_dual-0',
            walk = false,
            loop = true
        },
        ['sentar85'] = {
            dict = 'amb@incar@male@smoking_van@enter',
            anim = 'enter',
            walk = false,
            loop = true
        },
        ['sentar86'] = {
            dict = 'mp_safehouselost_table@',
            anim = 'lost_table_idle_a',
            walk = false,
            loop = true
        },
        ['sentar87'] = {
        ...
        ['sentar90'] = {
            dict = 'anim@amb@clubhouse@boardroom@boss@female@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar91'] = {
            dict = 'anim@amb@facility@briefing_room@seating@female@var_b@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar93'] = {
            dict = 'switch@franklin@stripclub3',
            anim = 'ig_17_base',
            walk = false,
            loop = true
        },
        ['sentar94'] = {
            dict = 'safe@franklin@ig_14',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar96'] = {
            dict = 'anim@amb@business@cfm@cfm_machine_no_work@',
            anim = 'hanging_out_operator',
            walk = false,
            loop = true
        },
        ['sentar97'] = {
            dict = 'timetable@reunited@ig_10',
            anim = 'shouldntyouguys_tracy',
            walk = false,
            loop = true
        },
        ['sentar98'] = {
            dict = 'missfbi3_party',
            anim = 'snort_coke_b_male5',
            walk = false,
            loop = true
        },
        ['sentar99'] = {
            dict = 'missheistpaletoscoresetupleadin',
            anim = 'rbhs_mcs_1_leadin',
            walk = false,
            loop = true
        },
        ['sentar100'] = {
            dict = 'misslester1aig_3exit',
            anim = 'air_guitar_01_exitloop_d',
            walk = false,
            loop = true
        },
        ['sentar101'] = {
        ...
        ['sentar102'] = {
            dict = 'misslester1aig_5intro',
            anim = 'boardroom_intro_f_c',
            walk = false,
            loop = true
        },
        ['sentar103'] = {
            dict = 'misslester1b_crowd@m_',
            anim = '001082_01_m_a',
            walk = false,
            loop = true
        },
        ...
        ['sentar106'] = {
            dict = 'switch@trevor@mocks_lapdance',
            anim = '001443_01_trvs_28_idle_man',
            walk = false,
            loop = true
        },
        ['sentar107'] = {
            dict = 'switch@trevor@rude_at_cafe',
            anim = '001218_03_trvs_23_rude_at_cafe_idle_female',
            walk = false,
            loop = true
        },
        ['sentar108'] = {
            dict = 'amb@world_human_seat_steps@female@hands_by_sides@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar109'] = {
            dict = 'amb@world_human_seat_wall@female@hands_by_sides@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar110'] = {
            dict = 'timetable@trevor@trv_ig_2',
            anim = 'base_trevor',
            walk = false,
            loop = true
        },
        ...
        ['sentar113'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@male@var_b@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar120'] = {
            dict = 'iaaj_ext-27',
            anim = 'csb_mp_agent14_dual-27',
            walk = false,
            loop = true
        },
        ['sentar121'] = {
            dict = 'anim@amb@facility@briefing_room@seating@male@var_b@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar122'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_a@base_l@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar123'] = {
            dict = 'missfam2_bikehire@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar127'] = {
            dict = 'anim@amb@office@seating@male@var_b@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar129'] = {
            dict = 'anim@amb@office@boardroom@crew@male@var_b@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar130'] = {
            dict = 'sub_int-38',
            anim = 'mp_m_freemode_01^1_dual-38',
            walk = false,
            loop = true
        },
        ['sentar131'] = {
            dict = 'sil_int-28',
            anim = 'mp_m_freemode_01_dual-28',
            walk = false,
            loop = true
        },
        ['sentar132'] = {
        ...
        ['sentar133'] = {
            dict = 'drf_mic_1_cs_1-24',
            anim = 'cs_drfriedlander_dual-24',
            walk = false,
            loop = true
        },
        ['sentar134'] = {
            dict = 'drf_mic_1_cs_1-30',
            anim = 'cs_drfriedlander_dual-30',
            walk = false,
            loop = true
        },
        ['sentar135'] = {
            dict = 'amb@lo_res_idles@',
            anim = 'prop_human_deckchair_female_lo_res_base',
            walk = false,
            loop = true
        },
        ['sentar136'] = {
        ...
        ['sentar137'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_a@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['sentar140'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_b@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar141'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_b@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar142'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_c@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar143'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_c@base_l@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar144'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@female@var_c@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar145'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@male@var_a@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar146'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@male@var_a@base_l@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar147'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@male@var_a@base_r@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['sentar148'] = {
            dict = 'anim@amb@clubhouse@boardroom@crew@male@var_b@base@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['foto'] = {
            dict = 'amb@lo_res_idles@',
            anim = 'world_human_lean_male_hands_together_lo_res_base',
            walk = false,
            loop = true
        },
        ['foto1'] = {
            dict = 'amb@code_human_cross_road@female@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['foto2'] = {
            dict = 'amb@code_human_in_car_mp_actions@tit_squeeze@bodhi@rps@base',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ['foto3'] = {
            dict = 'amb@world_human_hang_out_street@female_arm_side@enter',
            anim = 'enter',
            walk = false,
            loop = true
        },
        ...
        ['foto10'] = {
            dict = 'misstrevor2ron_basic_moves',
            anim = 'idle',
            walk = false,
            loop = true
        },
        ...
        ['foto16'] = {
            ...
            anim = 'low_idle_l_facecover',
            walk = false,
            loop = true
        },
        ['foto17'] = {
            dict = 'cover@weapon@core',
            anim = 'idle_turn_stop',
            walk = false,
            loop = true
        },
        ...
        ['foto19'] = {
            dict = 'anim@amb@casino@hangout@ped_male@stand@01a@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['foto26'] = {
            dict = 'amb@code_human_in_car_mp_actions@rock@bodhi@rps@base',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ['foto27'] = {
            dict = 'mini@hookers_spcrackhead',
            anim = 'idle_reject_loop_c',
            walk = false,
            loop = true
        },
        ['foto28'] = {
        ...
        ['foto29'] = {
            dict = 'switch@franklin@lamar_tagging_wall',
            anim = 'lamar_tagging_wall_loop_franklin',
            walk = false,
            loop = true
        },
        ['foto30'] = {
            dict = 'mp_move@prostitute@m@cokehead',
            anim = 'idle',
            walk = false,
            loop = true
        },
        ...
        ['foto32'] = {
            ...
            anim = 'look_ahead_l_a_m_y_vinewood_01',
            walk = false,
            loop = true
        },
        ['foto33'] = {
            dict = 'anim@special_peds@casino@beth@wheel@',
            anim = 'action10_beth',
            walk = false,
            loop = true
        },
        ...
        ['foto36'] = {
            ...
            anim = 'stripper_idle_03',
            walk = false,
            loop = true
        },
        ['foto37'] = {
            dict = 'mini@strip_club@idles@stripper',
            anim = 'stripper_idle_04',
            walk = false,
            loop = true
        },
        ['foto38'] = {
            dict = 'anim_heist@arcade@fortune@female@',
            anim = 'reaction_pondering',
            walk = false,
            loop = true
        },
        ['foto39'] = {
        ...
        ['foto40'] = {
            ...
            anim = 'stand_talk_loop_b_female',
            walk = false,
            loop = true
        },
        ['foto41'] = {
            dict = 'armenian_1_int-44',
            anim = 'a_m_y_musclbeac_01^1_dual-44',
            walk = false,
            loop = true
        },
        ['foto42'] = {
            dict = 'mp_clothing@female@trousers',
            anim = 'try_trousers_positive_a',
            walk = false,
            loop = true
        },
        ['foto43'] = {
            dict = 'silj_ext-19',
            anim = 'mp_m_freemode_01^3_dual-19',
            walk = false,
            loop = true
        },
        ['foto44'] = {
        ...
        ['foto45'] = {
            ...
            anim = 'ped_female@_stand@_02a@_idles_convo_idle_c',
            walk = false,
            loop = true
        },
        ['foto46'] = {
            dict = 'anim@arena@celeb@flat@solo@no_props@',
            anim = 'thumbs_down_a_player_a',
            walk = false,
            loop = true
        },
        ['foto47'] = {
            dict = 'guard_reactions',
            anim = '1hand_aiming_cycle',
            walk = false,
            loop = true
        },
        ['foto48'] = {
            dict = 'armenian_1_int-3',
            anim = 'a_f_y_fitness_02^5-3',
            walk = false,
            loop = true
        },
        ['foto49'] = {
            dict = 'anim_heist@arcade_combined@',
            anim = 'ped_female@_stand_withdrink@_01b@_base_base',
            walk = false,
            loop = true
        },
        ['foto50'] = {
            dict = 'amb@lo_res_idles@',
            anim = 'world_human_security_shine_torch_lo_res_base',
            walk = false,
            loop = true
        },
        ['foto51'] = {
            dict = 'rcmjosh2',
            anim = 'stand_lean_back_beckon_a',
            walk = false,
            loop = true
        },
        ['foto52'] = {
            dict = 'rcmjosh2',
            anim = 'stand_lean_back_beckon_b',
            walk = false,
            loop = true
        },
        ['foto53'] = {
            dict = 'pro_mcs_7_concat-1',
            anim = 'cs_priest_dual-1',
            walk = false,
            loop = true
        },
        ['foto54'] = {
        ...
        ['foto55'] = {
            dict = 'special_ped@pamela@trevor_1@trevor_1a',
            anim =
        ...
        ['foto56'] = {
            dict = 'special_ped@impotent_rage@intro',
            anim = 'idle_intro',
            walk = false,
            loop = true
        },
        ['foto57'] = {
            dict = 'random@escape_paparazzi@standing@',
            anim = 'idle',
            walk = false,
            loop = true
        },
        ['foto58'] = {
            dict = 'pro_mcs_7_concat-8',
            anim = 'player_two_dual-8',
            walk = false,
            loop = true
        },
        ['foto59'] = {
            dict = 'anim@heists@ornate_bank@thermal_charge',
            anim = 'cover_eyes_loop',
            walk = false,
            loop = true
        },
        ['foto60'] = {
            dict = 'low_fun_int-7',
            anim = 'cs_lamardavis_dual-7',
            walk = false,
            loop = true
        },
        ['foto61'] = {
            dict = 'tale_intro-12',
            anim = 'a_f_y_genhot_01^2_dual-12',
            walk = false,
            loop = true
        },
        ['foto62'] = {
        ...
        ['foto64'] = {
            dict = 'anim@mp_corona_idles@female_c@idle_a',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ...
        ['foto69'] = {
            ...
            anim = 'world_human_standing_male_01_idle_03',
            walk = false,
            loop = true
        },
        ['foto70'] = {
            dict = 'mic_4_int-0',
            anim = 'a_f_y_bevhills_04-0',
            walk = false,
            loop = true
        },
        ['foto71'] = {
            dict = 'mic_4_int-0',
            anim = 'cs_milton_dual-0',
            walk = false,
            loop = true
        },
        ['foto72'] = {
        ...
        ['foto75'] = {
            dict = 'amb@world_human_prostitute@crackhooker@idle_a',
            anim = 'idle_c',
            walk = false,
            loop = true
        },
        ...
        ['foto77'] = {
            dict = 'armenian_1_int-33',
            anim = 'ig_lamardavis_dual-33',
            walk = false,
            loop = true
        },
        ['foto78'] = {
        ...
        ['foto82'] = {
            ...
            anim = 'mp_player_int_bro_love_fp',
            walk = false,
            loop = true
        },
        ['foto83'] = {
            dict = 'hs3_arc_int-9',
            anim = 'csb_georginacheng_dual-9',
            walk = false,
            loop = true
        },
        ['foto84'] = {
            dict = 'armenian_1_int-0',
            anim = 'a_f_y_beach_01_dual-0',
            walk = false,
            loop = true
        },
        ['foto85'] = {
            dict = 'armenian_1_int-0',
            anim = 'a_f_y_hipster_02^2-0',
            walk = false,
            loop = true
        },
        ['foto86'] = {
            dict = 'armenian_1_int-0',
            anim = 'a_f_y_tourist_01^2-0',
            walk = false,
            loop = true
        },
        ['foto87'] = {
            dict = 'armenian_1_int-0',
            anim = 'a_m_y_beach_03-0',
            walk = false,
            loop = true
        },
        ['foto88'] = {
            dict = 'special_ped@pamela@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['foto89'] = {
            dict = 'mp_fm_intro_cut',
            anim = 'world_human_standing_male_01_idle_01',
            walk = false,
            loop = true
        },
        ['foto90'] = {
            dict = 'amb@world_human_leaning@female@smoke@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['foto94'] = {
            dict = 'amb@incar@male@smoking@idle_a',
            anim = 'idle_b',
            walk = false,
            loop = true
        },
        ...
        ['foto102'] = {
            dict = 'martin_1_int-0',
            anim = 'cs_patricia_dual-0',
            walk = false,
            loop = true
        },
        ['foto103'] = {
            dict = 'mini@strip_club@lap_dance_2g@ld_2g_decline',
            anim = 'ld_2g_decline_h_s2',
            walk = false,
            loop = true
        },
        ['foto104'] = { anim = 'stripper_idle_03', dict = 'mini@strip_club@idles@stripper', walk = false, loop = true },
        ['foto105'] = {
            dict = 'amb@world_human_binoculars@male@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['foto107'] = {
            ...
            anim = 'read_03_amy_skater_01',
            walk = false,
            loop = true
        },
        ['foto108'] = {
            dict = 'anim@heists@team_respawn@variations@variation_b_rot',
            anim = 'respawn_b_ped_c',
            walk = false,
            loop = true
        },
        ...
        ['foto112'] = {
            dict = 'switch@michael@pharmacy',
            anim = 'mics1_ig_11_loop',
            walk = false,
            loop = true
        },
        ['foto113'] = {
            dict = 'weapons@first_person@aim_idle@p_m_one@unarmed@fidgets@c',
        ...
        ['foto116'] = {
            dict = 'anim@amb@casino@hangout@ped_male@stand_withdrink@01b@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['foto117'] = {
            dict = 'anim@move_m@trash_rc',
            anim = 'aim_high_loop',
            walk = false,
            loop = true
        },
        ['foto118'] = {
            dict = 'martin_1_int-10',
            anim = 'cs_patricia_dual-10',
            walk = false,
            loop = true
        },
        ['foto119'] = {
            dict = 'club_open-30',
            anim = 'ig_djsolmanager_dual-30',
            walk = false,
            loop = true
        },
        ['foto120'] = {
            dict = 'anim_heist@arcade_combined@',
            anim = 'ped_female@_stand@_02a@_idles_convo_idle_d',
            walk = false,
            loop = true
        },
        ['foto121'] = {
        ...
        ['foto122'] = {
            dict = 'amb@world_human_golf_player@male@base',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['foto125'] = {
            dict = 'anim@amb@code_human_in_car_idles@arm@generic@ds@idle_j',
            anim = 'idle_lowdoor',
            walk = false,
            loop = true
        },
        ['foto126'] = {
            dict = 'club_open-0',
            anim = 'cs_lazlow_2_dual-0',
            walk = false,
            loop = true
        },
        ['foto127'] = {
            dict = 'armenian_1_int-33',
            anim = 'a_m_y_runner_01-33',
            walk = false,
            loop = true
        },
        ['tiktok'] = {
        ...
        ['tiktok18'] = {
            dict = 'custom@crossbounce',
            anim = 'crossbounce',
            walk = false,
            loop = true
        },
        ['tiktok19'] = {
            dict = 'custom@dont_start',
            anim = 'dont_start',
            walk = false,
            loop = true
        },
        ...
        ['tiktok22'] = {
            dict = 'custom@renegade',
            anim = 'renegade',
            walk = false,
            loop = true
        },
        ['tiktok23'] = {
            dict = 'custom@rickroll',
            anim = 'rickroll',
            walk = false,
            loop = true
        },
        ...
        ['tiktok27'] = {
            dict = 'custom@toosie_slide',
            anim = 'toosie_slide',
            walk = false,
            loop = true
        },
        ['tiktok28'] = {
            dict = 'custom@around_the_clock',
            anim = 'around_the_clock',
            walk = false,
            loop = true
        },
        ['tiktok29'] = {
            dict = 'custom@dancemoves',
            anim = 'dancemoves',
            walk = false,
            loop = true
        },
        ['tiktok30'] = {
            dict = 'custom@disco_dance',
            anim = 'disco_dance',
            walk = false,
            loop = true
        },
        ['tiktok31'] = {
            dict = 'custom@electroshuffle_original',
            anim = 'electroshuffle_original',
            walk = false,
            loop = true
        },
        ['tiktok32'] = {
            dict = 'custom@electroshuffle',
            anim = 'electroshuffle',
            walk = false,
            loop = true
        },
        ['tiktok33'] = {
            dict = 'custom@fresh_fortnite',
            anim = 'fresh_fortnite',
            walk = false,
            loop = true
        },
        ...
        ['tiktok36'] = {
            dict = 'custom@in_da_party',
            anim = 'in_da_party',
            walk = false,
            loop = true
        },
        ['tiktok37'] = {
            dict = 'custom@robotdance_fortnite',
            anim = 'robotdance_fortnite',
            walk = false,
            loop = true
        },
        ['tiktok38'] = {
            dict = 'custom@frightfunk',
            anim = 'frightfunk',
            walk = false,
            loop = true
        },
        ...
        ['tiktok40'] = {
            dict = 'custom@last_forever',
            anim = 'last_forever',
            walk = false,
            loop = true
        },
        ['tiktok41'] = {
            dict = 'custom@smooth_moves',
            anim = 'smooth_moves',
            walk = false,
            loop = true
        },
        ['tiktok42'] = {
            dict = 'custom@bellydance2',
            anim = 'bellydance2',
            walk = false,
            loop = true
        },
        ['tiktok43'] = {
            dict = 'custom@introducing',
            anim = 'introducing',
            walk = false,
            loop = true
        },
        ['tiktok44'] = {
            dict = 'custom@footwork',
            anim = 'footwork',
            walk = false,
            loop = true
        },
        ['tiktok45'] = {
            dict = 'custom@headspin',
            anim = 'headspin',
            walk = false,
            loop = true
        },
        ['tiktok46'] = {
            dict = 'custom@hiphop_pumpup',
            anim = 'hiphop_pumpup',
            walk = false,
            loop = true
        },
        ['tiktok47'] = {
            dict = 'custom@hiphop_yeah',
            anim = 'hiphop_yeah',
            walk = false,
            loop = true
        },
        ['tiktok48'] = {
            dict = 'custom@salsatime',
            anim = 'salsatime',
            walk = false,
            loop = true
        },
        ...
        ['tiktok50'] = {
            dict = 'custom@shockdance',
            anim = 'shockdance',
            walk = false,
            loop = true
        },
        ['tiktok51'] = {
            dict = 'custom@specialdance',
            anim = 'specialdance',
            walk = false,
            loop = true
        },
        ['tiktok52'] = {
            dict = 'custom@toetwist',
            anim = 'toetwist',
            walk = false,
            loop = true
        },
        ...
        ['encostar15'] = {
            dict = 'anim@amb@yacht@bow@male@variation_01@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['encostar19'] = {
            dict = 'misscarsteal1car_1_ext_leadin',
            anim = 'base_driver1',
            walk = false,
            loop = true
        },
        ...
        ['encostar22'] = {
            dict = 'missfbi1leadinout',
            anim = 'fbi_1_int_leadin_exit_loop_daven',
            walk = false,
            loop = true
        },
        ['encostar23'] = {
        ...
        ['encostar24'] = {
            dict = 'missheist_agency2aig_4',
            anim = 'look_plan_base_worker2',
            walk = false,
            loop = true
        },
        ['encostar25'] = {
            dict = 'missheistdockssetup1ig_12@base',
            anim = 'talk_gantry_idle_base_worker4',
            walk = false,
            loop = true
        },
        ['encostar26'] = {
            dict = 'missstrip_club_lean',
            anim = 'player_lean_rail_loop',
            walk = false,
            loop = true
        },
        ['encostar27'] = {
        ...
        ['encostar28'] = {
            dict = 'anim@amb@business@bgen@bgen_no_work@',
            anim = 'stand_phone_phoneputdown_fallasleep_nowork',
            walk = false,
            loop = true
        },
        ['encostar29'] = {
        ...
        ['encostar30'] = {
            dict = 'anim@amb@business@bgen@bgen_no_work@',
            anim = 'stand_phone_phoneputdown_stretching_nowork',
            walk = false,
            loop = true
        },
        ['encostar31'] = {
            dict = 'anim@amb@clubhouse@bar@bartender@',
            anim = 'greeting_c_bartender',
            walk = false,
            loop = true
        },
        ['encostar32'] = {
        ...
        ['encostar35'] = {
            ...
            anim = 'workers_talking_base_dockworker2',
            walk = false,
            loop = true
        },
        ['encostar36'] = {
            dict = 'switch@michael@sitting_on_car_bonnet',
            anim = 'sitting_on_car_bonnet_loop',
            walk = false,
            loop = true
        },
        ['encostar37'] = {
            dict = 'amb@world_human_leaning@male@wall@back@foot_up@react_shock',
            anim = 'front',
            walk = false,
            loop = true
        },
        ['encostar38'] = {
            dict = 'anim@amb@world_human_valet@informal@idle_a@',
            anim = 'idle_a_a_m_y_vinewood_01',
            walk = false,
            loop = true
        },
        ['encostar39'] = {
            dict = 'anim@amb@nightclub@dancers@club_ambientpeds@low-med_intensity',
            anim =
            'li-mi_amb_club_06_base_female^1',
            walk = false,
            loop = true
        },
        ['encostar41'] = {
            dict = 'silj_int-8',
            anim = 'csb_mp_agent14_dual-8',
            walk = false,
            loop = true
        },
        ['encostar42'] = {
            dict = 'anim@veh@btype@side_ds@base',
            anim = 'sit',
            walk = false,
            loop = true
        },
        ['encostar43'] = {
            dict = 'anim@veh@btype@side_ps@base',
            anim = 'sit',
            walk = false,
            loop = true
        },
        ['encostar44'] = {
            dict = 'timetable@michael@talk_phonebase',
            anim = 'talk_phone_base',
            walk = false,
            loop = true
        },
        ['encostar45'] = {
        ...
        ['encostar46'] = {
            dict = 'anim@amb@yacht@jacuzzi@standing@female@variation_02@',
            anim = 'base_b',
            walk = false,
            loop = true
        },
        ...
        ['encostar51'] = {
            dict = 'hs3_arc_int-15',
            anim = 'csb_wendy_dual-15',
            walk = false,
            loop = true
        },
        ['encostar52'] = {
            dict = 'anim@amb@yacht@rail@seated@female@variant_02@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['encostar53'] = {
            dict = 'anim@amb@yacht@rail@seated@male@variant_01@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['encostar55'] = {
            ...
            anim = 'turnaround_idle_v1_lazycook',
            walk = false,
            loop = true
        },
        ['encostar56'] = {
            dict = 'sub_int-42',
            anim = 'a_m_y_busicas_01_dual-42',
            walk = false,
            loop = true
        },
        ['encostar57'] = {
        ...
        ['encostar58'] = {
            dict = 'anim@amb@nightclub@dancers@club_ambientpeds@low-med_intensity',
            anim =
            'li-mi_amb_club_10_v1_male^3',
            walk = false,
            loop = true
        },
        ['encostar59'] = {
            dict = 'missheistdocks2aleadinoutlsdh_2a_int',
            anim = 'massage_loop_floyd',
            walk = false,
            loop = true
        },
        ['encostar60'] = {
        ...
        ['encostar61'] = {
            dict = 'anim@amb@yacht@jacuzzi@standing@female@variation_01@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ...
        ['encostar63'] = {
            dict = 'anim@amb@yacht@jacuzzi@standing@male@variation_01@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['encostar64'] = {
            dict = 'anim@amb@yacht@jacuzzi@standing@male@variation_02@',
            anim = 'base',
            walk = false,
            loop = true
        },
        ['encostar65'] = {
            ...
            anim = 'pier_lean_toss_cigarette',
            walk = false,
            loop = true
        },
        ['encostar66'] = {
            dict = 'missheistdockssetup1ig_10@idle_d',
            anim = 'talk_pipe_d_worker2',
            walk = false,
            loop = true
        },
        ['encostar67'] = {
            dict = 'missheistdockssetup1ig_10@idle_a',
            anim = 'talk_pipe_a_worker2',
            walk = false,
            loop = true
        },
        ['encostar68'] = {
            dict = 'amb@code_human_in_car_mp_actions@finger@std@rps@base',
            anim = 'idle_a',
            walk = false,
            loop = true
        },
        ...
        ['pose13'] = {
            dict = 'lunyx@random@v3@pose001',
            anim = 'random@v3@pose001',
            walk = true,
            loop = true
        },
        ['pose14'] = {
            dict = 'lunyx@random@v3@pose002',
            anim = 'random@v3@pose002',
            walk = true,
            loop = true
        },
        ['pose15'] = {
            dict = 'lunyx@random@v3@pose003',
            anim = 'random@v3@pose003',
            walk = false,
            loop = true
        },
        ['pose16'] = {
            dict = 'lunyx@random@v3@pose004',
            anim = 'random@v3@pose004',
            walk = false,
            loop = true
        },
        ['pose17'] = {
            dict = 'lunyx@random@v3@pose005',
            anim = 'random@v3@pose005',
            walk = false,
            loop = true
        },
        ['pose18'] = {
            dict = 'lunyx@random@v3@pose006',
            anim = 'random@v3@pose006',
            walk = true,
            loop = true
        },
        ['pose19'] = {
            dict = 'lunyx@random@v3@pose007',
            anim = 'random@v3@pose007',
            walk = true,
            loop = true
        },
        ['pose20'] = {
            dict = 'lunyx@random@v3@pose008',
            anim = 'random@v3@pose008',
            walk = true,
            loop = true
        },
        ['pose21'] = {
            dict = 'lunyx@random@v3@pose009',
            anim = 'random@v3@pose009',
            walk = true,
            loop = true
        },
        ['pose22'] = {
            dict = 'lunyx@random@v3@pose010',
            anim = 'random@v3@pose010',
            walk = true,
            loop = true
        },
        ['pose23'] = {
            dict = 'lunyx@random@v3@pose011',
            anim = 'random@v3@pose011',
            walk = true,
            loop = true
        },
        ['pose24'] = {
            dict = 'lunyx@random@v3@pose012',
            anim = 'random@v3@pose012',
            walk = true,
            loop = true
        },
        ['pose25'] = {
            dict = 'lunyx@random@v3@pose013',
            anim = 'random@v3@pose013',
            walk = true,
            loop = true
        },
        ['pose26'] = {
            dict = 'lunyx@random@v3@pose014',
            anim = 'random@v3@pose014',
            walk = true,
            loop = true
        },
        ['pose27'] = {
            dict = 'lunyx@random@v3@pose015',
            anim = 'random@v3@pose015',
            walk = true,
            loop = true
        },
        ['pose28'] = {
            dict = 'lunyx@random@v3@pose016',
            anim = 'random@v3@pose016',
            walk = true,
            loop = true
        },
        ['pose29'] = {
            dict = 'lunyx@random@v3@pose017',
            anim = 'random@v3@pose017',
            walk = false,
            loop = true
        },
        ['pose30'] = {
            dict = 'lunyx@random@v3@pose018',
            anim = 'random@v3@pose018',
            walk = true,
            loop = true
        },
        ['pose31'] = {
            dict = 'lunyx@random@v3@pose019',
            anim = 'random@v3@pose019',
            walk = true,
            loop = true
        },
        ['pose32'] = {
            dict = 'lunyx@random@v3@pose020',
        ...
        ['argumentar3'] = {
            dict = 'oddjobs@bailbond_hobohang_out_street_c',
            anim = 'idle_c',
            walk = false,
            loop = true
        },
        ['argumentar4'] = {
            dict = 'oddjobs@assassinate@old_lady',
            anim = 'looking_for_help',
            walk = false,
            loop = true
        },
        ['bow2'] = {
        ...
        ['dj3'] = {
            dict = 'anim@scripted@nightclub@dj@dj_moodm@',
            anim = 'moodm_cdj_left_a_12',
            walk = false,
            loop = true
        },
        ['dj4'] = {
            dict = 'anim@amb@nightclub_island@dancers@crowddance_facedj_transitions@from_low_intensity',
            anim =
        ...
        ['noway'] = {
            dict = 'oddjobs@towingpleadingbase',
            anim = 'base',
            walk = false,
            loop = false
        },
        ['noway2'] = {
            dict = 'gestures@m@car@std@casual@ds',
            anim = 'gesture_no_way',
            walk = false,
            loop = false
        },
        ['why'] = {
            dict = 'random@shop_robbery_reactions@',
            anim = 'is_this_it',
            walk = false,
            loop = false
        },
